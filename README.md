...
| `model:<model>.<effort>` | `/ptp:brainstorm`, `/ptp:prd`, `/ptp:brainstorm-full`, `/ptp:prd-full`, `/ptp:analyze` | Overrides the target model/effort for this invocation. |
