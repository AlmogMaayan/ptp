...
- `skills/ptp-github-projects-gh/references/content-body-mutation-route.md` — loaded when writing a title/body onto a non-draft (repository) board item's content.
...
`skills/ptp-github-projects-gh/references/content-body-mutation-route.md` §*The content-body mutation
route*.
...
`skills/ptp-github-projects-gh/references/content-body-mutation-route.md` §*The content-body mutation
route* admits — needs the **repository**
